...
# old place  /mnt/BactiPipes_MA2017/APHA_pipelines/SeqFinder/software/WGS_GeneMapper
# and run:
#	sh seqfinder_MA1.1.sh path_to_fastq_files
#	sh seqfinder_MA1.1.sh ~/mnt/Non-Defra_Projects/EU_Projects/IMPART_2018/RAW_WGS/Staphylococcus_hyicus/ 
