...
if len(sys.argv)>1:
    ...
    file_name = '/home/nickduggett/campy/AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6/20241009/UOF-C397-13/UOF-C397-13_CompareTo_AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6.csv'
    per_ID=70
    numsnps=100
    ...
    reference_name="AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6"
...
if database_type=="AMR":
    ...
    columns = ['class', 'gene_function', 'sub_class', 'source_organism', '1st_blast_match', '1st_blast_cov', '2nd_blast_match', '2nd_blast_cov', '3rd_blast_match', '3rd_blast_cov']
    ...
    output_columns.insert(5,'1st_blast_match')
    output_columns.insert(6,'1st_blast_cov')
    output_columns.insert(7,'2nd_blast_match')
    output_columns.insert(8,'2nd_blast_cov')
    output_columns.insert(9,'3rd_blast_match')
    output_columns.insert(10,'3rd_blast_cov')
