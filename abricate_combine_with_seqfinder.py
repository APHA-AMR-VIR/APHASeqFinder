...
if len(sys.argv)>1:
    ...
    df_abr = pd.read_csv('/home/nickduggett/seqfinder_testing/AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6/20230804/LREC5381/LREC5381.abricate', sep='\t')
    df_sf = pd.read_csv('/home/nickduggett/seqfinder_testing/AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6/20230804/LREC5381/LREC5381_CompareTo_AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6_good_snps.csv')
    df_original= pd.read_csv('/home/nickduggett/seqfinder_testing/AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6/20230804/LREC5381/LREC5381_CompareTo_AMRDatabase_20230526_and_EnteroPLasmids_20230526_short-tetA6.csv')
    efsa_dict=pd.read_csv('/home/nickduggett/mnt/fsx-044/Bactipipes/BactiPipes_SCE3/AMR_github/APHASeqFinder_4.0.6/EFSA_panel/EFSA_antimcriobial_panel_dictionary_20230526.csv')
    abricate_version="1.0.1"
    mlst_fasta= '/home/nickduggett/mnt/fsx-044/Bactipipes/BactiPipes_SCE3/AMR_github/APHASeqFinder_4.0.6/references/ECO-MLST-MG1655-alleles.fna'
    with open('/home/nickduggett/seqfinder_testing/LREC5381_UC.fasta') as f:
...
def combine_rows(group):
    if group["GENE"].nunique() == 1:  # Check if there are multiple identical strings
        ...
        required_coverage = gene_length * 0.9  # Calculate the required 95% coverage
...
values_to_check = ["TEM", "SHV", "CTX", "OXA", "CMY", "oqxA", "tet", "aadA","dfrA","mcr"]
...
abricate_columns=(df_sf.loc[:,['plasmid_abr','identity_abr','location_abr','coverage_abr','coverage_map_abr']])
df_sf=df_sf.iloc[:,:-5]
